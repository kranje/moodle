...
$string['file'] = 'File';
$string['filedisplaydefault'] = 'Default display option for files';
$string['filedisplaydefault_help'] = 'This setting determines the default display option for new files added to the course. It can be used to override the system-wide default.';
