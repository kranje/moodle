...
class locallib {
    ...
    public static function evaluate($answer, $question, $deletesubmissions) {
        ...
        try {
            ...
            $subid = (mod_vpl_edit::save($vpl, $userid, $files))->version;
    ...
    public static function get_info_from_step(question_attempt_step $step) {
        ...
        $sql = "SELECT qa.questionusageid as usageid, qa.slot
                  FROM {question_attempts} qa
                  JOIN {question_attempt_steps} qas ON qas.questionattemptid = qa.id
                 WHERE qas.id = :qasid";
        $qa = $DB->get_record_sql($sql, [ 'qasid' => $step->get_id() ]);
        return (object)[
