...
/**
 * Event triggered when a VPL Question evaluation is queued to be executed asynchronously via an adhoc task.
 ...
 * other['attemptid'] (quiz attempt id), other['queueid'] (id in question_vplquestion_queue table), other['taskid'].
 * @copyright  2024 Astor Bizard
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class question_evaluation_queued extends \core\event\base {
    /**
     * Init method.
     */
    ...
    public function get_description() {
        return "The question with id '$this->objectid' has been queued for evaluation for user with id '$this->relateduserid'" .
            " within the quiz with course module id '$this->contextinstanceid'. It is planned to be evaluated during adhoc task" .
    ...
    public static function get_name() {
        return get_string('eventquestionevaluationqueued', 'qtype_vplquestion');
    }
    ...
    protected function validate_data() {
        ...
        if (!array_key_exists('queueid', $this->other)) {
    ...
    public static function get_other_mapping() {
        return [
                ...
                'queueid' => \core\event\base::NOT_MAPPED,
