define(['jquery', 'core/log','core/str','core/ajax','core/notification','core/modal_save_cancel', 'core/modal_events'],
    function ($, log, str, Ajax, notification, ModalSaveCancel, ModalEvents) {
    "use strict"; // jshint ;_;
    /*
