...
### Fixed
- Completion progress not showing for sections containing subsections (delegated sections).
- Activity count not including activities inside subsections.
- Subsection modules themselves are now excluded from progress and activity counts.
