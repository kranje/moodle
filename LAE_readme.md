# [Moodle Liberal Arts Edition v3.8.3-LAE18.0.2]
...
Moodle 3.8.3+LAE18.0.2 consists of the core Moodle 3.8.3 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v3.8.3-LAE18.0.2
    git checkout -b v3.8.3-LAE18.0.2

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v3.8.3-LAE18.0.2-base tag instead.
