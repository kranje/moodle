# [Moodle Liberal Arts Edition v4.5.10-LAE27.0.8]
...
Moodle 4.5.10+LAE27.0.8 consists of the core Moodle 4.5.10 release plus a number of CLAMP-developed features and bug fixes.
...
A local plugin and accompanying block for displaying accessibility information about PDF uploads in a course to the instructors.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v4.5.10-LAE27.0.8
    git checkout -b v4.5.10-LAE27.0.8

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v4.5.10-LAE27.0.8-base tag instead.

CLAMP maintains two branches for each major version:

* LAE\_405\_STABLE contains the core code only
* LAE\_405\_PACKAGE includes the contributed modules
