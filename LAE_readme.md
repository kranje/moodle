# [Moodle Liberal Arts Edition v3.2.1-LAE12.0.0]
...
Moodle 3.2.1+LAE12.0.0 consists of the core Moodle 3.2.1 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v3.2.1-LAE12.0.0
    git checkout -b v3.2.1-LAE12.0.0

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v3.2.1-LAE12.0.0-base tag instead.
