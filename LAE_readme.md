# [Moodle Liberal Arts Edition v3.5.8-LAE15.0.9]
...
Moodle 3.5.8+LAE15.0.9 consists of the core Moodle 3.5.8 release plus a number of CLAMP-developed features and bug fixes.
...
Under certain conditions regrading a course can cause Moodle to get stuck in an infinite loop, leading to significant performance issues. This was identified and fixed in [MDL-64609](https://tracker.moodle.org/browse/MDL-64609) following the core 3.5.8 release and will be included in the core 3.5.8 release.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v3.5.8-LAE15.0.9
    git checkout -b v3.5.8-LAE15.0.9

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v3.5.8-LAE15.0.9-base tag instead.
