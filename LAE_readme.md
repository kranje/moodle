# [Moodle Liberal Arts Edition v3.11.11-LAE21.0.10]
...
Moodle 3.11.11+LAE21.0.10 consists of the core Moodle 3.11.11 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v3.11.11-LAE21.0.10
    git checkout -b v3.11.11-LAE21.0.10

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v3.11.11-LAE21.0.10-base tag instead.

CLAMP maintains two branches for each major version:

* LAE\_311\_STABLE contains the core code only
* LAE\_311\_PACKAGE includes the contributed modules
