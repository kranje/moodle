# [Moodle Liberal Arts Edition v3.1.12-LAE11.0.12]
...
Moodle 3.1.12+LAE11.0.12 consists of the core Moodle 3.1.12 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v3.1.12-LAE11.0.12
    git checkout -b v3.1.12-LAE11.0.12

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v3.1.12-LAE11.0.12-base tag instead.
