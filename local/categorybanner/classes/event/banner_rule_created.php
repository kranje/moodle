...
/**
 * The banner rule created event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class banner_rule_created extends \core\event\base {
    ...
    public function get_description() {
        if ($this->other['global']) {
            return "The user with id '{$this->userid}' created a new global banner rule.";
        }
        return "The user with id '{$this->userid}' created a new banner rule for category with id '{$this->other['categoryid']}'.";
    }
    ...
    public static function get_name() {
        return get_string('eventbannerrulecreated', 'local_categorybanner');
    }
