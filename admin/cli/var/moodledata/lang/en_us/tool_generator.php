...
/**
 * Strings for component 'tool_generator', language 'en_us', version '5.1'.
 *
...
This is intended to provide a standardized measure for checking the reliability
...
file system space (tens of gigabytes). You will need to delete the courses
