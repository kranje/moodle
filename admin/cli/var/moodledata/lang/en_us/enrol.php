...
/**
 * Strings for component 'enrol', language 'en_us', version '5.1'.
 *
 * @package     enrol
 * @category    string
...
$string['plugindisabled'] = '{$a} enroll plugin is disabled';
...
$string['privacy:metadata:user_enrolments:timecreated'] = 'The date/time  when the user enrollment was created.';
$string['privacy:metadata:user_enrolments:timeend'] = 'The date/time  when the user enrollment ends.';
$string['privacy:metadata:user_enrolments:timemodified'] = 'The date/time  when the user enrollment was modified.';
$string['privacy:metadata:user_enrolments:timestart'] = 'The date/time  when the user enrollment starts.';
...
$string['unenrolnotpermitted'] = 'You do not have permission to unenroll this user from this course.';
