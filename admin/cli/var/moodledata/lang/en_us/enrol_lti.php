...
/**
 * Strings for component 'enrol_lti', language 'en_us', version '5.1'.
 *
 * @package     enrol_lti
 * @category    string
...
$string['deletedactivitydescription'] = 'The activity shared by this instance has been deleted. You can select another activity to share by editing the instance or, if no longer required, you can simply delete the instance. Deleting the instance will remove any associated user enrollments.';
