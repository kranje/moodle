...
/**
 * Strings for component 'enrol_self', language 'en_us', version '5.1'.
 *
 * @package     enrol_self
 * @category    string
...
$string['enrolkeyrequired'] = 'An enrollment key will be required.';
...
Your enrollment in the course {$a->course} expires on {$a->timeend} as you have not accessed it in the last {$a->inactivetime} days.

To keep your enrollment active, log in and access <a href="{$a->url}">{$a->course}</a> before {$a->timeend}.';
$string['expiryinactivemessageenrolledsubject'] = 'Your enrollment is expiring: {$a->course}';
...
$string['newenrols'] = 'Allow new  self enrollments';
...
$string['passwordmatchesgroupkey'] = 'This enrollment key is already used as a group enrollment key.';
...
$string['status'] = 'Keep current self enrollments active';
$string['status_desc'] = 'Enable self enrollment method in new courses.';
$string['syncenrolmentstask'] = 'Synchronize self enrollments task';
