...
/**
 * Strings for component 'question', language 'en_us', version '5.1'.
 *
 * @package     question
 * @category    string
...
$string['privacy:metadata:link:qbehaviour'] = 'The Question subsystem makes use of the Question Behavior plugin type.';
$string['qbanknotfound'] = 'The \'{$a}\' question bank plugin doesn\'t exist or is not recognized.';
...
$string['questionbehavioursdisabledexplained'] = 'Enter a comma separated list of behaviors you do not want to appear in the drop-down menu.';
$string['questionbehavioursorder'] = 'Question behaviors order';
$string['questionbehavioursorderexplained'] = 'Enter a comma separated list of behaviors in the order you want them to appear in the drop-down menu.';
