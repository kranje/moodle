...
/**
 * Strings for component 'mnetservice_enrol', language 'en_us', version '5.1'.
 *
...
$string['privacy:metadata:mnetservice_enrol_enrolments:enroltime'] = 'The date/time when the enrollment was modified.';
