...
/**
 * Strings for component 'quiz', language 'en_us', version '5.1'.
 *
 * @package     quiz
 * @category    string
...
This setting only affects questions and behaviors (such as immediate feedback or interactive with multiple tries) where it is possible to finish a question before the attempt is submitted.';
$string['canredoquestions_help'] = 'If enabled, after finishing attempting a question, a \'Try another question like this one\' button is displayed. This allows for a similar question (selected randomly) to be attempted, or the same question again, without the entire quiz attempt having to be submitted and another attempt started. This option is useful for practice quizzes.

This setting only affects questions and behaviors (such as immediate feedback or interactive with multiple tries) where it is possible to finish a question before the attempt is submitted.If enabled, after finishing attempting a question, a \'Try another question like this one\' button is displayed. This allows for a similar question (selected randomly) to be attempted, or the same question again, without the entire quiz attempt having to be submitted and another attempt started. This option is useful for practice quizzes.
...
$string['configintroglobal'] = 'These settings control the system-wide behavior of the Quiz activity.';
...
$string['editmaxmark'] = 'Edit maximum point';
$string['feedbackerrorboundaryformat'] = 'Feedback grade boundaries must be either a percentage or a number. The value you entered in boundary {$a} is not recognized.';
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the quiz. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the quiz when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalized for the server being slow. However, the student could cheat and get this many seconds to answer the quiz. You have to make a trade-off based on how much you trust the performance of your server during quizzes.';
$string['marks'] = 'Points';
$string['marks_help'] = 'The numerical points for each question, and the overall attempt score. You can only select Points if Maximum points is selected.';
$string['maxmark'] = 'Maximum point';
$string['maxmarks'] = 'Maximum points';
$string['maxmarks_help'] = 'The maximum point available for each question.';
$string['precreateattempts_desc'] = 'Pre-creating attempts helps optimize site performance. In addition to enabling this setting, you need to set a pre-create attempts period. Note: The setting only applies to quizzes with an opening time.';
$string['precreateattempts_help'] = 'Pre-creating attempts helps optimize site performance. Quiz questions cannot be modified once a quiz has attempts.';
