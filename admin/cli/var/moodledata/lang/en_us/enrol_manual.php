...
/**
 * Strings for component 'enrol_manual', language 'en_us', version '5.1'.
 *
...
$string['managemanualenrolements'] = 'Manage manual enrollments';
...
';
$string['syncenrolmentstask'] = 'Synchronise manual enrollments task';
