...
/**
 * Strings for component 'enrol_ldap', language 'en_us', version '5.1'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['createcourseextid'] = 'CREATE User enrolled to a nonexistent course \'{$a->courseextid}\'';
$string['createnotcourseextid'] = 'User enrolled to a nonexistent course \'{$a->courseextid}\'';
...
$string['syncenrolmentstask'] = 'Synchronize enrollments task';
